...
public class DefaultHTSLabelSerializer implements Serializer {
    ...
    /** Should we adapt the pause name by expanding the type of punctuation if one is associated */
    protected boolean add_punctuation_type;
    ...
    public void setAddPunctuationType(Boolean add_punctuation_type) {
        this.add_punctuation_type = add_punctuation_type;
    }
    ...
    protected String expandPunctuation(String punc) {
        if (punc.equals(","))
            return "COMMA";
        if (punc.equals(":"))
            return "COLON";
     ...
     */
    protected String convertPh(String ph, String punctuation) throws MaryException {
        ...
        if (set_nss.contains(ph)) {
            if (ph.equals("_") || ph.equals("sil")) {
                ph = "pau";
            }

            if (! punctuation.equals(getUndefSymbol())) {
                ph += this.expandPunctuation(punctuation);
            }
    ...
    protected String format(FeatureMap feature_map) throws MaryException {
        ...
        String cur_lab = String.format(format,
                // Phoneme
                convertPh(getValue(feature_map, "prev_prev_phone"), getValue(feature_map, "prev_prev_nss_punctuation")),
                convertPh(getValue(feature_map, "prev_phone"), getValue(feature_map, "prev_nss_punctuation")),
                convertPh(getValue(feature_map, "phone"), getValue(feature_map, "nss_punctuation")),
                convertPh(getValue(feature_map, "next_phone"), getValue(feature_map, "next_nss_punctuation")),
                convertPh(getValue(feature_map, "next_next_phone"), getValue(feature_map, "next_next_nss_punctuation")),
        ...
        if (is_nss) {
            ...
            cur_lab += String.format(format,
                    ...
                    getUndefSymbol(), getUndefSymbol(),
                    convertPh(getValue(feature_map, "syl_vowel"), getUndefSymbol()),
