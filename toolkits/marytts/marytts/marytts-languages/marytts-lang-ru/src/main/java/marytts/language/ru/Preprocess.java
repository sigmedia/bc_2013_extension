...
public class Preprocess extends MaryModule {
	...
	super("preprocessing");
	this.lexicon = null;
        this.rbnf = new RuleBasedNumberFormat(new ULocale("ru"), RuleBasedNumberFormat.SPELLOUT);
        this.cardinalRule = "%spellout-numbering";
        this.ordinalRule = ""; // FIXME: not working for russian: getOrdinalRuleName(rbnf);
        this.yearRule = getYearRuleName(rbnf);
        this.df = DateFormat.getDateInstance(DateFormat.LONG, new ULocale("ru"));
        try {
	...
	this.description = "Token preprocessing class for russian";
    }
    ...
    protected void expand(Utterance utt) throws ParseException, IOException,
		...
		System.out.println("t = " + t.toString());
            ...
            // // ordinal (FIXME: not working for russian)
    ...
    protected String expandDate(String date) throws ParseException {
        ...
        Date humanDate = df.getPatternInstance("MM.dd.yyyy", new ULocale("ru")).parse(date);
    ...
    public static Map<Object, Object> loadAbbrevMap() throws IOException {
        ...
        // FIXME: there is no abbrev map for russian yet
