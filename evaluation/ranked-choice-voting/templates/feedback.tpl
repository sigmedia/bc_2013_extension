...
<form action="./save" method="post" class="form-example">
    ...
    <div class="form-group">
        <label for="difficulty">How difficult did you find the test?</label>
        ...
        <select id="difficulty" name="difficulty" class="form-control" required>
            ...
            <option value="really difficult">Really Difficult</option>
        </select>
    </div>
    <div class="form-group">
        <label for="video_useful">Did you find the instruction video useful?</label>

        <select id="video_useful" name="video_useful" class="form-control" required>
            <option value="" selected disabled hidden>Choose here</option>
            <option value="useful">It was useful</option>
            <option value="not_needed">I didn't need it, but was happy to have it</option>
            <option value="not_useful">I was not useful</option>
        </select>
    </div>
